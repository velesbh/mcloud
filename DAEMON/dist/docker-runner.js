...
export function imageForJava(major) {
 ...
 */
export function resolveHostPath(p) {
    try {
...
export async function ensureImage(image, onLine) {
 ...
 */
export function spawnDockerJava(opts) {
...
export function killContainer(serverId) {
...
export function stopContainer(serverId, timeoutSec = 30) {
    const name = containerName(serverId);
    try {
